        ...
        <div className="space-y-2">
            {documents.map((doc) => (
                <button
                    ...
                    className="w-full text-left grid grid-cols-[auto_1fr_auto] items-center gap-4 p-4 rounded-2xl bg-[#0C0C0E] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                ...
                >
                    ...
                    <div>
                        <p className="font-bold text-white truncate">{doc.displayName || doc.fileName}</p>
